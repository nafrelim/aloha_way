...
urlpatterns = [
    ...
    path('trainer/<int:pk>/', views.TrainerDetailView.as_view(), name='detail_trainer_view'),
    path('trainer/add/', views.TrainerCreateView.as_view(), name='trainer_add_view'),
    path('trainer/del/<int:pk>/', views.TrainerDeleteView.as_view(), name='del_trainer_view'),
    ...
    path('student/<int:pk>/', views.StudentDetailView.as_view(), name='detail_student_view'),
    ...
    path('packet/<int:pk>/', views.PacketDetailView.as_view(), name='detail_packet_view'),
    ...
    path('booking/<int:pk>/', views.BookingDetailView.as_view(), name='detail_booking_view'),
    ...
    path('training/<int:pk>/', views.TrainingDetailView.as_view(), name='detail_training_view'),
    ...
    path('training/acceptance/<int:training_id>/', views.TrainingAcceptanceView.as_view(),
         name='acceptance_training_view'),
