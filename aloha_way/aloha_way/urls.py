...
urlpatterns = [
    ...
    # path('timetables/del/<int:id>/', views.TimetableDelView.as_view(), name='timetable_del_view'),
    # path('timetables/modify/<int:id>/', views.TimetableModifyView.as_view(), name='timetable_mod_view'),
